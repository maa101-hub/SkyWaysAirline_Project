...
public class BookingController {
    ...
    public ResponseEntity<ApiResponse<String>> cancelBooking(
        ...
        log.info("Received cancel booking request for reservationId: {}", reservationId);

        service.cancelBooking(reservationId);

        log.info("Booking cancelled successfully for reservationId: {}", reservationId);

        return ResponseEntity.ok(
                new ApiResponse<>("Booking cancelled successfully", "SUCCESS")
        );
    }
